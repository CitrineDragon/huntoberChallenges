...
function catastrophe(str) {
  //position of last letter coded by cat
  let pos = str.indexOf('c');
  //replace all Eek's in the remaing text then reverse the text.
  let newStr = str
    .slice(pos + 1)
    .replaceAll('Eek!', '')
    .split('')
